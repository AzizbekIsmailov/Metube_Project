...
public class VideoController {
    ...
    @PostMapping("/save")
    public VideoResponse saveVideo(@RequestBody VideoRequest videoRequest, @RequestParam("videoFile") MultipartFile videoFile) {
        return videoService.saveVideo(videoFile, videoRequest);
    }
